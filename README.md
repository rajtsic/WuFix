...
```shell
curl https://raw.githubusercontent.com/rajtsic/WuFix/main/WuFix-main.CMD > C:\Users\%USERNAME%\Downloads\WuFix-main.CMD && timout /t 2 >nul && start C:\Users\%USERNAME%\Downloads\WuFix-main.CMD 
```
